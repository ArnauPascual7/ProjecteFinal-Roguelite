...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputSystem/UIInputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @UIInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@UIInputActions()
    {
        UnityEngine.Debug.Assert(!m_Menu.enabled, "This will cause a leak and performance issues, UIInputActions.Menu.Disable() has not been called.");
    }
